...
<template>
  ...
  >
    <div class="toolbar">
      <div v-if="props.icon" class="block-icon">
        <button>
          <i
            :class="{
              [props.icon]: true,
...
.repeater-block {
  ...
  .navigation {
    ...
    .nav-button {
      ...
      &:hover {
        box-shadow: inset 0 0 0 1px #e4e7ed, inset 0 0 0 2px #ffffff,
          0 1px 1px #dcdfe6;
      }
